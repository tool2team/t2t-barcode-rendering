...
namespace T2t.Barcode.Core.Dmtx
{
    public class DmtxMessage
    {
        ...
        #region Constructors
        public DmtxMessage(DmtxSymbolSize sizeIdx, DmtxFormat symbolFormat)
        {
        ...
        #region Methods
        public void DecodeDataStream(DmtxSymbolSize sizeIdx, byte[] outputStart)
        {
            bool macro = false;
        ...
        public static byte UnRandomize255State(byte value, int idx)
        {
        ...
        public int SymbolModuleStatus(DmtxSymbolSize sizeIdx, int symbolRow, int symbolCol)
        {
