...
public partial class BarcodeTestForm : Form
{
    ...
    private readonly int _maxBarHeight = 30;
    private readonly int _barcodeColumns = 2;
    private readonly int _barcodesPerPage = 20;
    private readonly int _barcodePadding = 10;
    ...
    private void testTree_AfterSelect(object sender, TreeViewEventArgs e)
    {
        ...
        if (e.Node.Tag is SymbologyTestItem testItem)
        {
