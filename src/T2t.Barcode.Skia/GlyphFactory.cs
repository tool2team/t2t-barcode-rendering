...
namespace T2t.Barcode.Skia
{
    ...
    public abstract class GlyphFactory
    {
        ...
        /// <see cref="T:T2t.Barcode.Skia.GlyphFactory"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="T:T2t.Barcode.Skia.BarGlyph"/> at the specified
        /// ordinal index.
        /// </summary>
        /// <param name="index">The glyph ordinal index.</param>
        /// <returns>
        /// A <see cref="T:T2t.Barcode.Skia.BarGlyph"/> glyph object.
        /// </returns>
        ...
        /// <summary>
        /// Gets the <see cref="T:T2t.Barcode.Skia.BarGlyph"/> that corresponds
        ...
        /// </summary>
        /// <param name="glyph">
        /// The <see cref="T:T2t.Barcode.Skia.BarGlyph"/> to be located.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Gets the array of <see cref="T:T2t.Barcode.Skia.Glyph"/> objects that
        /// correspond to the specified character.
        /// </summary>
        /// <param name="character">The character to be translated.</param>
        /// <returns>
        /// A collection of <see cref="T:T2t.Barcode.Skia.Glyph"/> objects.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// <summary>
        /// Gets the collection of <see cref="T:T2t.Barcode.Skia.BarGlyph"/> that 
        ...
        /// <summary>
        /// Gets the collection of <see cref="T:T2t.Barcode.Skia.CompositeGlyph"/>
        /// that represent the composite bar-code glyphs for the given bar-code
        /// symbology.
        /// </summary>
        /// <returns>
        /// The full collection of <see cref="T:T2t.Barcode.Skia.CompositeGlyph"/>
