...
namespace T2t.Barcode.Svg
{
	...
	/// sole abstract method <see cref="M:T2t.Barcode.Skia.Checksum.GetChecksum"/>.
	/// </remarks>
	public abstract class Checksum
	{
		#region Protected Constructors
		/// <summary>
		/// Initialises a new instance of <see cref="T:T2t.Barcode.Skia.Checksum"/> class.
		/// </summary>
		protected Checksum ()
		{
		}
		...
		/// <summary>
		/// Gets an array of <see cref="T:T2t.Barcode.Skia.Glyph"/> objects that
	...
	/// that are attached to an object derived from <see cref="T:T2t.Barcode.Skia.GlyphFactory"/>
	/// for fetching the checksum glyph characters.
	/// </summary>
	/// <typeparam name="T">
	/// A factory class derived from <see cref="T:T2t.Barcode.Skia.GlyphFactory"/>.
	/// </typeparam>
		...
		where T: GlyphFactory
	{
		...
		#region Protected Constructors
		/// <summary>
		/// Initialises a new instance of <see cref="T:T2t.Barcode.Skia.FactoryChecksum"/>
		/// class with the specified <see cref="T:T2t.Barcode.Skia.GlyphFactory"/> derived
		/// object.
		/// </summary>
		/// <param name="factory">
