...
namespace T2t.Barcode.Svg
{
    ...
    public class CompositeGlyph : Glyph
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:T2t.Barcode.Skia.CompositeGlyph"/>
        /// class.
        /// </summary>
        ...
        /// <summary>
        /// Gets the first <see cref="T:T2t.Barcode.Skia.BarGlyph"/> object.
        /// </summary>
        /// <value>A <see cref="T:T2t.Barcode.Skia.BarGlyph"/>.</value>
        ...
        /// <summary>
        /// Gets the second <see cref="T:T2t.Barcode.Skia.BarGlyph"/> object.
        /// </summary>
        /// <value>A <see cref="T:T2t.Barcode.Skia.BarGlyph"/>.</value>
