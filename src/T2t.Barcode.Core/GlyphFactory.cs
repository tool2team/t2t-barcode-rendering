...
public abstract class GlyphFactory
{
    ...
    /// <see cref="T:T2t.Barcode.Core.GlyphFactory"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="T:T2t.Barcode.Core.BarGlyph"/> at the specified
    /// ordinal index.
    /// </summary>
    /// <param name="index">The glyph ordinal index.</param>
    /// <returns>
    /// A <see cref="T:T2t.Barcode.Core.BarGlyph"/> glyph object.
    /// </returns>
    ...
    /// <summary>
    /// Gets the <see cref="T:T2t.Barcode.Core.BarGlyph"/> that corresponds
    ...
    /// </summary>
    /// <param name="glyph">
    /// The <see cref="T:T2t.Barcode.Core.BarGlyph"/> to be located.
    /// </param>
    /// <returns>
    ...
    /// <summary>
    /// Gets the array of <see cref="T:T2t.Barcode.Core.Glyph"/> objects that
    ...
    /// <summary>
    /// Gets the collection of <see cref="T:T2t.Barcode.Core.BarGlyph"/> that 
    ...
    /// <summary>
    /// Gets the collection of <see cref="T:T2t.Barcode.Core.CompositeGlyph"/>
    /// that represent the composite bar-code glyphs for the given bar-code
    /// symbology.
    /// </summary>
    /// <returns>
    /// The full collection of <see cref="T:T2t.Barcode.Core.CompositeGlyph"/>
