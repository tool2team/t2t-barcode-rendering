...
{
    public static class DmtxCommon
    {
        public static void GenReedSolEcc(DmtxMessage message, DmtxSymbolSize sizeIdx)
        {
            byte[] g = new byte[69];
            byte[] b = new byte[68];
        ...
        public static int GetSymbolAttribute(DmtxSymAttribute attribute, DmtxSymbolSize sizeIdx)
        {
        ...
        public static int GetBlockDataSize(DmtxSymbolSize sizeIdx, int blockIdx)
        {
            int symbolDataWords = GetSymbolAttribute(DmtxSymAttribute.DmtxSymAttribSymbolDataWords, sizeIdx);
        ...
        public static DmtxSymbolSize FindCorrectSymbolSize(int dataWords, DmtxSymbolSize sizeIdxRequest)
        {
        ...
        public static int GetBitsPerPixel(DmtxPackOrder pack)
        {
            switch (pack)
            {
        ...
        public static bool DecodeCheckErrors(byte[] code, int codeIndex, DmtxSymbolSize sizeIdx, int fix)
        {
        ...
        public static double RightAngleTrueness(DmtxVector2 c0, DmtxVector2 c1, DmtxVector2 c2, double angle)
        {
